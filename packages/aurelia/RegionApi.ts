...
/**
 * createRegionDnsRecord - parameters interface
 */
export interface ICreateRegionDnsRecordParams {
  regionId: string;
  dnsRecord: DnsRecord;
}
...
/**
 * listRegionDnsRecords - parameters interface
 */
export interface IListRegionDnsRecordsParams {
  regionId: string;
}
...
export class RegionApi extends Api {
   ...
   */
  async createRegionDnsRecord(params: ICreateRegionDnsRecordParams): Promise<DnsRecord> {
    // Verify required parameters are set
    this.ensureParamIsSet('createRegionDnsRecord', params, 'regionId');
    this.ensureParamIsSet('createRegionDnsRecord', params, 'dnsRecord');

    // Create URL to call
    const url = `${this.basePath}/region/{regionId}/record`
      .replace(`{${'regionId'}}`, encodeURIComponent(`${params['regionId']}`));
   ...
   * @param params.regionId The ID of the region.
   */
  async listRegionDnsRecords(params: IListRegionDnsRecordsParams): Promise<Array<string>> {
    // Verify required parameters are set
    this.ensureParamIsSet('listRegionDnsRecords', params, 'regionId');

    // Create URL to call
    const url = `${this.basePath}/region/{regionId}/records`
      .replace(`{${'regionId'}}`, encodeURIComponent(`${params['regionId']}`));
