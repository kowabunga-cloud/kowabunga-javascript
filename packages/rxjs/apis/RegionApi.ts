...
export interface CreateRegionDnsRecordRequest {
    regionId: string;
    dnsRecord: DnsRecord;
}
...
export interface ListRegionDnsRecordsRequest {
    regionId: string;
}
...
export class RegionApi extends BaseAPI {
     ...
     */
    createRegionDnsRecord({ regionId, dnsRecord }: CreateRegionDnsRecordRequest): Observable<DnsRecord>
    createRegionDnsRecord({ regionId, dnsRecord }: CreateRegionDnsRecordRequest, opts?: OperationOpts): Observable<AjaxResponse<DnsRecord>>
    createRegionDnsRecord({ regionId, dnsRecord }: CreateRegionDnsRecordRequest, opts?: OperationOpts): Observable<DnsRecord | AjaxResponse<DnsRecord>> {
        throwIfNullOrUndefined(regionId, 'regionId', 'createRegionDnsRecord');
        throwIfNullOrUndefined(dnsRecord, 'dnsRecord', 'createRegionDnsRecord');
        ...
        return this.request<DnsRecord>({
            url: '/region/{regionId}/record'.replace('{regionId}', encodeURI(regionId)),
            method: 'POST',
            headers,
            body: dnsRecord,
        }, opts?.responseOpts);
     ...
     */
    listRegionDnsRecords({ regionId }: ListRegionDnsRecordsRequest): Observable<Array<string>>
    listRegionDnsRecords({ regionId }: ListRegionDnsRecordsRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<string>>>
    listRegionDnsRecords({ regionId }: ListRegionDnsRecordsRequest, opts?: OperationOpts): Observable<Array<string> | AjaxResponse<Array<string>>> {
        throwIfNullOrUndefined(regionId, 'regionId', 'listRegionDnsRecords');
        ...
        return this.request<Array<string>>({
            url: '/region/{regionId}/records'.replace('{regionId}', encodeURI(regionId)),
            method: 'GET',
            headers,
        }, opts?.responseOpts);
    };
