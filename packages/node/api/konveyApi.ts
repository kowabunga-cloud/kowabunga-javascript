...
export enum KonveyApiApiKeys {
    ApiKeyAuth,
}

export class KonveyApi {
    ...
    public setApiKey(key: KonveyApiApiKeys, value: string) {
        (this.authentications as any)[KonveyApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async deleteKonvey (konveyId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/konvey/{konveyId}'
            .replace('{' + 'konveyId' + '}', encodeURIComponent(String(konveyId)));
        ...
        // verify required parameter 'konveyId' is not null or undefined
     ...
     */
    public async listKonveys (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<string>;  }> {
        const localVarPath = this.basePath + '/konvey';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
     ...
     * @param konveyId The ID of the Konvey (Kowabunga Network Load-Balancer).
     */
    public async readKonvey (konveyId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Konvey;  }> {
        const localVarPath = this.basePath + '/konvey/{konveyId}'
            .replace('{' + 'konveyId' + '}', encodeURIComponent(String(konveyId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async updateKonvey (konveyId: string, konvey: Konvey, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Konvey;  }> {
        const localVarPath = this.basePath + '/konvey/{konveyId}'
            .replace('{' + 'konveyId' + '}', encodeURIComponent(String(konveyId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
