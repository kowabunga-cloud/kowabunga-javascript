...
export class RegionApi {
     ...
     */
    public async createRegionDnsRecord (regionId: string, dnsRecord: DnsRecord, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DnsRecord;  }> {
        const localVarPath = this.basePath + '/region/{regionId}/record'
            .replace('{' + 'regionId' + '}', encodeURIComponent(String(regionId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param regionId The ID of the region.
     */
    public async listRegionDnsRecords (regionId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<string>;  }> {
        const localVarPath = this.basePath + '/region/{regionId}/records'
            .replace('{' + 'regionId' + '}', encodeURIComponent(String(regionId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
